<?php
/**
 * Committee Chair on Health Layout
 * Usage: include at top of any Committee Chair view AFTER setting $pageTitle and $activeNav
 */
if (session_status() === PHP_SESSION_NONE) session_start();
if (!isset($_SESSION['user_id']) || $_SESSION['role'] !== 'Committee Chair on Health') {
...
$userName    = $_SESSION['user_name'] ?? 'Committee Chair';
...
$nav = [
    ['key'=>'dashboard',           'label'=>'Dashboard',         'icon'=>'bi-speedometer2',    'url'=>'index.php?action=committeeChairDashboard'],
    ['key'=>'affected_children',   'label'=>'Affected Children', 'icon'=>'bi-clipboard-data',  'url'=>'index.php?action=reviewAffectedChildren'],
    ['key'=>'minutes_review',      'label'=>'Meeting Minutes',   'icon'=>'bi-journal-text',    'url'=>'index.php?action=chairMinutesList'],
    ['key'=>'feeding_program',     'label'=>'New Proposal',      'icon'=>'bi-plus-circle-fill','url'=>'index.php?action=proposalForm'],
...
<aside class="kn-sidebar" id="sidebar">
    <div class="sidebar-brand">
        <a href="index.php?action=committeeChairDashboard" class="brand-text">🍲 Kusi<em>Nay</em></a>
        <span class="brand-badge">Committee Chair</span>
    </div>
    ...
    <div class="sidebar-footer">
        <div class="sidebar-user">
            ...
            <div class="info">
                ...
                <div class="role">Committee Chair on Health</div>
            </div>
