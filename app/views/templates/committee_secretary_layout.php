<?php
/**
 * Committee Secretary Layout
 * Usage: include at top of any Committee Secretary view AFTER setting $pageTitle and $activeNav
 */
if (session_status() === PHP_SESSION_NONE) session_start();
if (!isset($_SESSION['user_id']) || $_SESSION['role'] !== 'Committee Secretary') {
...
$userName    = $_SESSION['user_name'] ?? 'Committee Secretary';
...
$nav = [
    ['key'=>'dashboard',     'label'=>'Meeting Minutes', 'icon'=>'bi-journal-text',    'url'=>'index.php?action=secretaryDashboard'],
    ['key'=>'record',        'label'=>'Record Minutes',  'icon'=>'bi-plus-circle-fill','url'=>'index.php?action=minutesForm'],
...
<aside class="kn-sidebar" id="sidebar">
    <div class="sidebar-brand">
        <a href="index.php?action=secretaryDashboard" class="brand-text">🍲 Kusi<em>Nay</em></a>
        <span class="brand-badge">Secretary</span>
    </div>
    ...
    <div class="sidebar-footer">
        <div class="sidebar-user">
            ...
            <div class="info">
                ...
                <div class="role">Committee Secretary</div>
            </div>
