...
<div class="page-card p-4 p-md-5">
    ...
    <div class="text-center mb-4">
        ...
        <h2 class="h5 fw-bold mb-1" style="color:var(--kn-dark)">Set Your Password</h2>
        <p style="font-size:.88rem;color:var(--kn-muted);margin:0">
            Your account was created by your BNS. Please set a personal password before continuing.
        </p>
    </div>
    ...
    <form action="index.php?action=forceChangePassword" method="POST" novalidate>
        <?= \Security::csrfField() ?>
        ...
        <button type="submit" class="btn btn-primary w-100 btn-lg">
            <i class="bi bi-shield-lock-fill me-1"></i> Set Password &amp; Continue
        </button>
    </form>
</div>
